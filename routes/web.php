...
Route::middleware(['auth:sanctum', 'verified', 'rols'])->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'verified'])->get('/run/download/{id}/{date}', [RunController::class, 'downloadPdf'])->name('run.downloadPdf');
    Route::middleware(['auth:sanctum', 'verified'])->get('/run/downloadPlus/{id}/{date}', [RunController::class, 'downloadPlus'])->name('run.downloadPlus');
