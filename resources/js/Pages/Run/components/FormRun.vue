<template>
    <form @submit.prevent="submitForm">
      ...
      >
        <h1 class="text-center py-5 font-bold text-2xl flex">
          ...
          class="p-5 rounded-md text-white  ml-1 btn-image"
          >
            <img src="/images/clone-icon.svg" alt="clone icon"/>
          </button>
        </h1>
        <div>
  ...
  export default {
    ...
    setup(props, { emit }) {
      const { form, v$, submitForm, loading, options, addForm, deleteSection, duplicateSection } =
        useFormRun();
