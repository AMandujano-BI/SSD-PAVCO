        ...
        $("#activeRuns").DataTable({
          ...
          columns: [
            ...
            { 
              targets: 6,
              render: function( data, type, row, meta ) {
                return '<td class="text-center">'+ calculateHours( row.id,
                  row.status,
                  row.created_at,
                  row.isEdit,
                  row.last_edit,
            ...
            { 
              ...
              render: function( data, type, row, meta ) {
                if (row.status === 1) {
                  return '<button class="showclose" itemId='+row.id+' disabled>  <svg width="25" height="25" class="grayscale" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path fill="#17C4B2" d="M0 0h25v25H0z"/><path stroke="#FFF" stroke-linecap="round" d="m7 7 11.129 11.129M18.129 7 6.999 18.129"/></g></svg>  </button>';
                } else {
                  return '<button class="showclose" itemId='+row.id+'>  <svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path fill="#17C4B2" d="M0 0h25v25H0z"/><path stroke="#FFF" stroke-linecap="round" d="m7 7 11.129 11.129M18.129 7 6.999 18.129"/></g></svg> </button>';
                }
              }
            },
            { 
              ...
              render: function( data, type, row, meta ) {
                if (row.status === 0) {
                  return '<button class="showreopen" itemId='+row.id+' disabled>  <svg width="25" height="25" class="grayscale" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path fill="#0ABC8A" d="M0 0h25v25H0z"/><rect stroke="#FFF" x="6.5" y="6.5" width="8" height="8" rx="1"/><rect stroke="#FFF" x="11.5" y="11.5" width="8" height="8" rx="1"/></g></svg> </button>';
                } else {
                  return '<button class="showreopen" itemId='+row.id+'> <svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path fill="#0ABC8A" d="M0 0h25v25H0z"/><rect stroke="#FFF" x="6.5" y="6.5" width="8" height="8" rx="1"/><rect stroke="#FFF" x="11.5" y="11.5" width="8" height="8" rx="1"/></g></svg> </button>';
                }
              }
            },
            { 
