        ...
        <tr v-for="run in runs" :key="run.id">
          ...
          <td class="text-center">
            <button @click="showDelete(run.id)">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"  viewBox="0 0 24 24" stroke="#E71F2A" >
          ...
          <td class="text-center">
            <button @click="showNotes(run.id)">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="#DA9C14" >
          ...
          <td class="text-center">
              <button>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#7DBB52" >
