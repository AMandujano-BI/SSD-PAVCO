<template>
    <div class="container p-9">
        ...
        <tbody>
            <tr v-for="run in runs" :key="run.id">
                ...
                <td class="text-center">
                    <button @click="showReOpen">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd" />    <path d="M6 12a2 2 0 012-2h8a2 2 0 012 2v2a2 2 0 01-2 2H2h2a2 2 0 002-2v-2z" />
                        </svg>
                    </button>
                </td>
                <td class="text-center">
    ...
    <modal :show="isModalPhotos">
        <div class="container mx-auto p-5">
            <button @click="closePhotosModal" class="bg-red-600 text-white p-2 rounded-md">
              X
            </button>
            ...
            <ul>
                ...
                <li><strong>Description: </strong>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt est sequi beatae at maiores ullam vero aut. Laudantium ad blanditiis nisi nemo aliquam quas, modi facere dolores aut consequatur commodi!</li>
            </ul>

            <div class="mt-5">
                <img src="https://scontent.fpbc2-3.fna.fbcdn.net/v/t1.6435-9/p600x600/70238220_669796293529180_5931468986758725632_n.jpg?_nc_cat=109&ccb=1-5&_nc_sid=730e14&_nc_ohc=uxlVucpTS8AAX_rKFeJ&_nc_ht=scontent.fpbc2-3.fna&oh=9df88e410008751c7d9af7cfaf9078c2&oe=61C20B6E" alt="">
            </div>
        </div>
    </modal>

    <modal :show="isModalResults" :maxWidth="max-w-md">
        <div class="container mx-auto p-5">
            <button @click="closeResultsModal" class="bg-red-600 text-white p-2 rounded-md">
              X
            </button>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li> <strong>Description: </strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit placeat dignissimos debitis modi pariatur eum vitae incidunt perferendis iure officiis assumenda quisquam nobis quia, laudantium, nihil explicabo sit dolores rem?</li>
                </ul>
            </div>
            <hr>
            <h3>Parts Data</h3>
     ...
     <modal :show="isModalNotes">
        <div class="container mx-auto p-5">
            <button @click="closeNotesModal" class="bg-red-600 text-white p-2 rounded-md">
              X
            </button>
            <p class="text-xl font-bold text-center">Run notes</p>
            <p>The note editor is used for viewing / adding notes to a run</p>
            <hr>
            <div>
...
export default {
    ...
    methods: {
        ...
        async gettingData() {
            const response = await axios.get('/run/getAllRuns')
                                        .then((resp) => {
