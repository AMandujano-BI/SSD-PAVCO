        ...
        $("#tableCompanies").DataTable({
          ...
          drawCallback: function () {
            ...
            $(".openmodaldeleteclick").on("click", function (e) {
              const openmodaldeleteclickStr =  e.currentTarget.attributes[1].value;
